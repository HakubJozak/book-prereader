...
documents = [
    'Once upon a time, there was a girl named Cinderella. All Cinderella did all day, every day, was scrub the floor, do the laundry, cook the meals, and wash the dishes.',
...
stoplist = set(
    "for . , ? ' ! t there here who what which have get got may but a are as an all of the and to in all at they i he she we you could can was every each is has had did do their his her your our my".split())
